...
public class MenuController {
    ...
    private static void cadastrarDoador(
        ...
        doadorRepository.adicionarDoador(
                new Doador(
                        idDoador++,
                        nomeD,
                        telD,
    ...
    private static void cadastrarBeneficiario(
            Scanner sc,
            BeneficiarioRepository beneficiarioRepository) {
        ...
        Integer prioridade = lerInteiro(
                sc,
                "Prioridade: ",
                "Erro: Prioridade deve ser um número."
        );
        ...
        beneficiarioRepository.adicionarBeneficiario(
                new Beneficiario(
                        idBeneficiario++,
                        nomeB,
                        telB,
    ...
    private static void cadastrarItem(
        ...
        System.out.print(
                "Estado (bom, ruim, danificado): "
        );

        String estado = sc.nextLine();

        itemRepository.adicionarItemDoado(
                new ItemDoacao(
                        idItem++,
                        nomeItem,
                        cat,
    ...
    private static void solicitarItem(
        ...
        Integer idBeneficiarioSolicitacao =
                lerInteiro(
                        sc,
                        "Digite o ID do beneficiário: ",
                        "Erro: ID inválido."
                );
        ...
        Beneficiario beneficiario =
                beneficiarioRepository.buscarPorId(
                        idBeneficiarioSolicitacao
                );
